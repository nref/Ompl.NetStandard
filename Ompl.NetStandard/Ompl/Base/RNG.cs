...
public class RNG : global::System.IDisposable {
  ...
  public void uniformNormalVector(SWIGTYPE_p_std__vectorT_double_t v) {
    ompl_basePINVOKE.RNG_uniformNormalVector(swigCPtr, SWIGTYPE_p_std__vectorT_double_t.getCPtr(v));
    if (ompl_basePINVOKE.SWIGPendingException.Pending) throw ompl_basePINVOKE.SWIGPendingException.Retrieve();
  }

  public void uniformInBall(double r, SWIGTYPE_p_std__vectorT_double_t v) {
    ompl_basePINVOKE.RNG_uniformInBall(swigCPtr, r, SWIGTYPE_p_std__vectorT_double_t.getCPtr(v));
    if (ompl_basePINVOKE.SWIGPendingException.Pending) throw ompl_basePINVOKE.SWIGPendingException.Retrieve();
  }
