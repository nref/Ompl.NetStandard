...
public class ProgressDisplay : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ompl_geometricPINVOKE.delete_ProgressDisplay(swigCPtr);
        }
  ...
  public ProgressDisplay() : this(ompl_geometricPINVOKE.new_ProgressDisplay__SWIG_1(), true) {
    if (ompl_geometricPINVOKE.SWIGPendingException.Pending) throw ompl_geometricPINVOKE.SWIGPendingException.Retrieve();
  }

  public uint count() {
    uint ret = ompl_geometricPINVOKE.ProgressDisplay_count(swigCPtr);
    if (ompl_geometricPINVOKE.SWIGPendingException.Pending) throw ompl_geometricPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
