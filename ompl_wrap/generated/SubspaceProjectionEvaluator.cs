...
public class SubspaceProjectionEvaluator : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ompl_wrapPINVOKE.delete_SubspaceProjectionEvaluator(swigCPtr);
        }
  ...
  public void setup() {
    ompl_wrapPINVOKE.SubspaceProjectionEvaluator_setup(swigCPtr);
  }

  public uint getDimension() {
    uint ret = ompl_wrapPINVOKE.SubspaceProjectionEvaluator_getDimension(swigCPtr);
    return ret;
  }
